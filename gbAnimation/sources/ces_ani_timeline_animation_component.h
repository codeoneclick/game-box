//
//  ces_ani_timeline_animation_component.h
//  gbAnimation
//
...
#ifndef ces_ani_timeline_animation_component_h
#define ces_ani_timeline_animation_component_h
...
namespace gb
{
    ...
    {
        class ani_timeline;
        class ces_ani_timeline_animation_component : public ces_base_component
        {
        private:
        ...
        public:
            ...
            CTTI_CLASS_GUID(ces_ani_timeline_animation_component, ces_base_component::g_guids_container)
            ces_ani_timeline_animation_component();
            ~ces_ani_timeline_animation_component();
