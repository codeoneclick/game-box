//
//  ces_ani_base_timeline_component.h
//  gbAnimation
//
...
namespace gb
{
    namespace anim
    {
        class ces_ani_base_timeline_component : public ces_base_component
        {
        private:
        ...
        public:
            ...
            CTTI_CLASS_GUID(ces_ani_base_timeline_component, ces_base_component::g_guids_container)
            ces_ani_base_timeline_component();
            ~ces_ani_base_timeline_component();
