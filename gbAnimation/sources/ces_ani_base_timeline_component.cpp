//
//  ces_ani_base_timeline_component.cpp
//  gbAnimation
//
...
namespace gb
{
    namespace anim
    {
        ces_ani_base_timeline_component::ces_ani_base_timeline_component() :
        m_timeline(nullptr),
        ...
        void ces_ani_base_timeline_component::next_frame(f32 dt)
        {
            if(m_is_playing)
            {
