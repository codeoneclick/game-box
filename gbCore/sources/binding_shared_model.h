...
namespace gb
{
	...
	public:
		...
		STTI_CLASS_GUID(binding_shared_record, i_binding_record::g_guids_container, override)
	...
	private:
		...
		std::unordered_map<stti_guid_t, std::shared_ptr<std::list<i_binding_model_shared_ptr>>> m_pools;
		std::unordered_map<stti_guid_t, std::shared_ptr<std::list<i_binding_model_shared_ptr>>> m_storages;
	...
	public:
		...
		STTI_CLASS_GUID(binding_shared_model, i_binding_model::g_guids_container, override)
		...
		void register_storage_and_pool(stti_guid_t guid)
		{
		...
		bool is_storage_and_pool_registered(stti_guid_t guid) const;
		...
		std::shared_ptr<std::list<i_binding_model_shared_ptr>> get_storage(stti_guid_t guid);
		std::shared_ptr<std::list<i_binding_model_shared_ptr>> get_pool(stti_guid_t guid);
