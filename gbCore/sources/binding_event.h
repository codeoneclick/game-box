...
namespace gb
{
	...
	public:
		...
		binding_event_model_prop(stti_guid_t record_id, const std::string& prop_id, const std::shared_ptr<i_binding_event_callback>& callback) : i_binding_event(generate_guid(record_id, prop_id), callback)
		{
		}
		...
		static std::string generate_guid(stti_guid_t record_id, const std::string& prop_id)
		{
			std::stringstream ss;
