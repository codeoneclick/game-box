...
namespace gb
{
    ...
    public:
        ...
        f32 get_bone_weight(const std::string& bone_name) const;
    };
    ...
    public:
        ...
        STTI_CLASS_GUID(ces_animation_3d_mask_component, ces_base_component::g_guids_container)
        ...
        f32 get_bone_weight(const std::string& animation_name, const std::string& bone_name) const;
    };
};
