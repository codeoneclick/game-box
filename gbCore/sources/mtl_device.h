...
namespace gb
{
    ...
    public:
        ...
        virtual void* get_mtl_raw_ws_command_buffer_ptr() const = 0;
        virtual void* get_mtl_raw_ss_command_buffer_ptr() const = 0;
        virtual void* get_mtl_raw_output_command_buffer_ptr() const = 0;
        virtual void* get_mtl_raw_current_render_pass_descriptor() = 0;
