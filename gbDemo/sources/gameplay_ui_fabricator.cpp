...
namespace game
{
    ...
    gb::game_object_2d_shared_ptr gameplay_ui_fabricator::create_quest_dialog(const std::string& filename)
    {
        auto quest_accept_button = m_ui_fabricator.lock()->create_button(glm::vec2(256.f, 32.f), nullptr);
        quest_accept_button->position = glm::vec2(64.f, 300.f);
        quest_accept_button->set_text("accept");
        quest_accept_button->attach_sound("sound_01.mp3", gb::ui::button::k_pressed_state);
        
        auto quest_decline_button = m_ui_fabricator.lock()->create_button(glm::vec2(256.f, 32.f), nullptr);
        quest_decline_button->position = glm::vec2(512.f, 300.f);
