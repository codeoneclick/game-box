...
namespace game
{
    class attack_button : public gb::game_object_2d
    {
    public:
        ...
        typedef std::function<void(const gb::ces_entity_shared_ptr&)> on_tap_on_attack_callback_t;
    ...
    private:
        ...
        on_tap_on_attack_callback_t m_on_tap_on_attack_callback;
    ...
    public:
        ...
        void set_on_tap_on_attack_callback(const on_tap_on_attack_callback_t& callback);
    };
};
