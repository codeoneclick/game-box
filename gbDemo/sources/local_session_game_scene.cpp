...
namespace game
{
    ...
    void local_session_game_scene::create()
    {
        ...
        m_spawn_points[4] = glm::vec2(1024.f + 128.f, 1024.f + 128.f);
        m_spawn_points[5] = glm::vec2(128.f, 1024.f + 128.f);
        m_spawn_points[6] = glm::vec2(1024.f + 128.f, 128.f);
        m_spawn_points[7] = glm::vec2(2048.f - 128.f, 128.f);
        m_spawn_points[8] = glm::vec2(128.f, 2048.f - 128.f);
        m_spawn_points[9] = glm::vec2(2048.f - 128.f, 2048.f - 128.f);
