...
namespace cs
{
    ...
    void game_objects_drag_controller::add_game_object(const gb::game_object_shared_ptr &game_object)
    {
        ...
        bound_touch_compoent->enable(gb::e_input_state_dragged, gb::e_input_source_mouse_left, false);
        bound_touch_compoent->add_callback(gb::e_input_state_dragged, std::bind(&game_objects_drag_controller::on_dragged, this, std::placeholders::_1,
                                                                                std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
        bound_touch_compoent->enable(gb::e_input_state_pressed, gb::e_input_source_mouse_left, true);
        bound_touch_compoent->add_callback(gb::e_input_state_pressed, std::bind(&game_objects_drag_controller::on_touched, this, std::placeholders::_1,
                                                                                std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
        bound_touch_compoent->enable(gb::e_input_state_released, gb::e_input_source_mouse_left, true);
        bound_touch_compoent->add_callback(gb::e_input_state_released, std::bind(&game_objects_drag_controller::on_touched, this, std::placeholders::_1,
                                                                                 std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
    }
                                                  ...
                                                  gb::e_input_source input_source, gb::e_input_state input_state)
    {
        ...
        if(input_state == gb::e_input_state_pressed)
        {
            ...
            bound_touch_compoent->enable(gb::e_input_state_dragged, gb::e_input_source_mouse_left, true);
