...
namespace cs
{
                                                  ...
                                                  gb::e_input_element input_element, gb::e_input_state input_state)
    {
        ...
        if(input_state == gb::e_input_state_pressed)
        {
            ...
            glm::vec2 size = glm::vec2(fabsf(bound.x) + fabsf(bound.w),
                                       fabsf(bound.y) + fabsf(bound.z));
    ...
    void game_objects_drag_controller::on_dragged(const gb::ces_entity_shared_ptr& entity, const glm::vec2& point,
                                                  gb::e_input_element input_element, gb::e_input_state input_state)
    {
        if(m_selected_game_object)
        {
            ...
            std::static_pointer_cast<gb::ces_transformation_component>(entity->get_component(gb::e_ces_component_type_transformation));
