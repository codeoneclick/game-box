...
namespace game
{
    ...
    private:
        ...
        f32 m_max_collision_protection_time = 2000.f;
    ...
    public:
        ...
        STTI_CLASS_GUID(ces_car_drift_state_component, gb::ces_base_component::g_guids_container)
        ...
        std::property_ro<f32> max_collision_protection_time;
