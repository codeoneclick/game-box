...
namespace game
{
    ...
    bool db_character_quest_tasks_table::load_from_db(i32 id, char* raw_data, i32& size, bool all, const read_data_callback_t& callback)
    {
    ...
    bool db_character_quest_tasks_table::save_to_db(i32 id, const char* raw_data, i32 size)
    {
        std::stringstream predicate;
        predicate<<"insert or replace into quest_tasks(id, data) values("<<id<<", ?);";
