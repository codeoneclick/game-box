...
namespace game
{
    ...
    characters_3d_assembler::characters_3d_assembler(const gb::scene_graph_shared_ptr& scene_graph,
    ...
    std::pair<gb::sprite_shared_ptr, gb::shape_3d_shared_ptr> characters_3d_assembler::create_character(const std::string& character_sprite_filename,
    ...
    void characters_3d_assembler::remove_character(const gb::ces_entity_shared_ptr& character)
    {
