...
std::shared_ptr<configuration> get_car_configuration(const std::string& filename) const;
...
std::shared_ptr<configuration> get_levels_set_configuration(const std::string& filename) const;
